...
//   UserAdmin,
//   View,
//   ViewOff, Store, Application, CloudServices,
...
//     href: "https://10.126.192.122:3010/", 
//     target: "_blank",
...
//     id: "agent-studio",
//     href: "https://agentbuilder.edl.dev.awsdns.internal.das/", 
//     target: "_blank",
//     rel: "noopener noreferrer",
//   },
//   {
...
//     id: "mcp-gateway",
//     href: "https://eda-oauthmanager.edl.dev.awsdns.internal.das/", 
//     target: "_blank",
//     rel: "noopener noreferrer",
//   },
//   ];
...
import logo from "../../assests/images/logo.png"
import { AppBar, Box, CssBaseline, Divider, Drawer, List, ListItem, ListItemIcon, ListItemText } from "@mui/material"
import { useAuth } from "contexts/AuthContext"
import { TypeProps } from "interface"
import Admin from "pages/Admin/index"
import DashboardContent from "pages/DashboardContent"
...
function Dashboard() {
  ...
  useEffect(() => {
    const checkLocalVal = localStorage.getItem("edp_checkAdmin")
    if (checkLocalVal) {
      // Still validate in background but don't auto-show submenu
    }
  }, [])
  ...
  // Insert submenu items right after Admin if showAdminSubmenu is true
  if (showAdminSubmenu) {
    menuItems.push(
      { text: "Project", icon: <IbmCloudProjects size={20} />, id: "project", submenu: true },
      { text: "Metrics", icon: <Analytics size={20} />, id: "metrics", submenu: true },
  ...
  // Add external link items at the end
  menuItems.push(
    {
      text: "Agent Marketplace",
      icon: <Store size={20} />,
    ...
    <Box sx={{ display: "flex", height: "100vh" }}>
      ...
      >
        ...
        >
          {!collapsed ? (
            <>
              <img src={logo || "/placeholder.svg"} alt="Logo" style={{ height: "40px", width: "auto" }} />
              <TagLine>
                {currentTab === "dashboard"
                  ? "Data Intelligence Platform"
                  : "Elevance Data Intelligence Platform Dashboard"}
